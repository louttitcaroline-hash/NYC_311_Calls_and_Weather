...
# Tabs
# ============================
tab_summary, tab_preparation_calls, tab_preparation_weather, tab_descriptive_calls, tab_descriptive_weather, tab_merged, tab_forecasting = st.tabs([
...
with tab_summary:
    ...
    st.markdown(
        ...
        - Improve location precision: standardized geocoding, building IDs, and parcel-level joins to enable hyper-local weather/impact modelling.
        - Use more expressive models: gradient-boosted trees or time-series models with cross-validation and probabilistic forecasting to capture nonlinear/weather-interaction effects.
